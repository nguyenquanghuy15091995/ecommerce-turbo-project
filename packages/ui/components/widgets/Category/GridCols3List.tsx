...
export interface GridCols3CategoryListProps {
  title?: string;
  titleProps?: Omit<TypographyProps, "children">;
  items?: CategoryData[];
}

export const GridCols3CategoryList: FC<GridCols3CategoryListProps> = ({
  title,
  titleProps,
  items,
}) => {
  return (
    <>
      <div className="container mx-auto py-10">
        ...
        {Array.isArray(items) && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-5 pb-7">
...
export default GridCols3CategoryList;
